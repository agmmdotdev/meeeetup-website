  ...
  const articles = [
    {
        ...
        description: "MeeeetUpが顔認識イベントプラットフォームを正式にリリース 次世代のイベント...",
        content: "MeeeetUpは、顔認識技術を活用した革新的なイベントプラットフォームを正式にリリースしました。このプラットフォームは、イベントの受付、セキュリティ、ネットワーキングを効率化し、参加者にシームレスな体験を提供します。",
    },
     {
        title: "2024年のイベントテックトレンド予測",
        slug: "2024-event-tech-trends",
        category: "news",
        description: "2024年に注目すべきイベントテクノロジーのトレンドについて解説します。",
        content: "2024年は、AIと生体認証技術がイベント業界に革命をもたらす年となるでしょう。特に顔認識技術は、非接触での入場管理やパーソナライズされた体験の提供において中心的な役割を果たすと予測されています。",
    },
    {
        title: "大手カンファレンスでのMeeeetUp導入事例",
        slug: "major-conference-case-study",
        category: "case_study",
        description: "5000人規模のテックカンファレンスでMeeeetUpが導入され、受付時間が大幅に短縮されました。",
        content: "先日開催されたTechSummit 2024において、MeeeetUpの顔認識チェックインシステムが導入されました。従来は1人あたり30秒かかっていた受付時間が、顔パスによりわずか3秒に短縮され、参加者から高い評価を得ました。",
    },
     {
        title: "TechCrunchにMeeeetUpが掲載されました",
        slug: "meeeetup-featured-in-techcrunch",
        category: "media_coverage",
        description: "世界的なテクノロジーメディアTechCrunchにて、MeeeetUpの革新的な取り組みが紹介されました。",
        content: "TechCrunchの記事「未来のイベント体験」において、MeeeetUpが特集されました。記事では、プライバシーに配慮した顔認識技術の実装や、イベント主催者向けのデータ分析機能について詳しく報じられています。",
    }
  ];
